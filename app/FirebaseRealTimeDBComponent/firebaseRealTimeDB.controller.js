...
exports.getAllProject = function(req, res) {
    firebaseRealTimeDBModel.getAllProject(function(error, result) {
        if (error) {
            res.send(error);
        } else {
            res.status(200).send(result);
...
exports.getAllProjectByGroup = function(req, res) {
    firebaseRealTimeDBModel.getAllProjectByGroup(req.params.groupId, function(error, result) {
        if (error) {
            res.send(error);
        } else {
            res.status(200).send(result);
