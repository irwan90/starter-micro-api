...
router.get('/getAllProject', firebaseRealTimeDBValidator.getAllProject);
router.get('/getAllProjectByGroup/:groupId', firebaseRealTimeDBValidator.getAllProjectByGroup);
